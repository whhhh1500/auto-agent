...
current schema is `storage.SQLSchemaVersion == 46`. A migration is forward
only: an opener rejects a stored version newer than 46 before it executes
current DDL.
...
| v41 -> v42 -> v43 -> v44 -> v45 -> v46 | `TestSQLSchemaV41MigratesAuthorizationEpoch` advances the additive chain to v46; sidecar/witness tests cover v42 -> v44, `TestSQLSchemaV44MigratesNativeQueuedModelInvocations` covers v44 -> v45, and `TestSQLSchemaV45MigratesNativeQueuedModelOutcomes` covers v45 -> v46 without backfill | PostgreSQL exercises the same chain; `TestPostgresSchemaV44MigratesNativeQueuedModelInvocations` and `TestPostgresSchemaV45MigratesNativeQueuedModelOutcomes` verify the last two additive boundaries against disposable schemas |
...
- The SQLite suite gives concrete historical row-preservation evidence for v1,
  v19, v22, v25, v26, v27, v31, v33, v34, v35, v36, v37, v40, v41, v42, v43, v44, v45, and v46. It exercises cumulative transition paths
