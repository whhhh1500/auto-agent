...
current schema is `storage.SQLSchemaVersion == 45`. A migration is forward
only: an opener rejects a stored version newer than 45 before it executes
current DDL.
...
| v41 -> v42 -> v43 -> v44 -> v45 | `TestSQLSchemaV41MigratesAuthorizationEpoch` verifies a pre-v42 marker gains the additive `store_meta.authorization_epoch=0` row and advances to v45; the sidecar/witness tests cover v42 -> v44, and `TestSQLSchemaV44MigratesNativeQueuedModelInvocations` verifies the direct v44 -> v45 empty-attempt upgrade | PostgreSQL exercises the same epoch/sidecar/witness paths, while `TestPostgresSchemaV44MigratesNativeQueuedModelInvocations` verifies v44 -> v45 without attempt backfill against a disposable schema |
...
- The SQLite suite gives concrete historical row-preservation evidence for v1,
  v19, v22, v25, v26, v27, v31, v33, v34, v35, v36, v37, v40, v41, v42, v43, v44, and v45. It exercises cumulative transition paths
